...
class Tomd:
    ...
    def convert(self, html="", options=None):
        ...
        elements.sort(key=lambda ele: ele.start_pos)
...
if __name__ == "__main__":
    t = Tomd(
        """<p><b>123</b></p><p><b><i>456</i></b></p><p><i>789</i></p><h2>123</h2><blockquote>456</blockquote><div class="highlight"><pre><code class="language-text"><span></span>789
